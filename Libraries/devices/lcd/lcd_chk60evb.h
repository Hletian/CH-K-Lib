...
void LCD_DrawHLine(uint16_t YPos, uint16_t XPos0, uint16_t XPos1, uint16_t Color);
void LCD_DrawVLine(uint16_t XPos, uint16_t YPos0, uint16_t YPos1, uint16_t Color);
void LCD_Init(void);
