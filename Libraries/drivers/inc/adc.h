/**
  ...
  * @version V2.4
  * @date    2013.5.23
  * @brief   Ë∂ÖÊ†∏K60Ô∆∫‰ª∂Â∫?ADCÊ®°ÂùóÈ©±Âä® Â§¥Êñá‰ª?
  ******************************************************************************
  */
#ifndef __ADC_H__
#define __ADC_H__
...
typedef struct
{
  uint32_t ADCxMap;             //ADC „ÕöÈÅì„ÕâÊã©
	uint32_t ADC_Precision;       //ADC Á≤æÂ∫¶„ÕâÊã©
	uint16_t ADC_TriggerSelect;   //ADC Ëß¶ÂèëÊ∫êÈÄâÊã©
	uint16_t ADC_ClkDiv;          //ADC ËΩ¨Êç¢ÂàÜÂ±è„ÕâÊã©
}ADC_InitTypeDef;
